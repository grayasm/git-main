 ...
 *
 *    Because some attributes of top windows are overriden by WM, we will
 *    create a child window and change only its attributes.
 */
...
int main(int argc, char** argv)
{
	...
	childattr.override_redirect = False;
