 ...
 *
 * $Id: ti_wtime_get.cpp 550076 2007-06-23 18:18:24Z sebor $
 *
 ***************************************************************************
 *
...
_RWSTD_SPECIALIZE_FACET_ID (time_get, TARGS_W);
_RWSTD_DEFINE_FACET_FACTORY (static, time_get, TARGS_W, wtime_get);
