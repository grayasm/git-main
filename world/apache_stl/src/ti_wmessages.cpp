 ...
 *
 * $Id: ti_wmessages.cpp 550076 2007-06-23 18:18:24Z sebor $
 *
 ***************************************************************************
 *
...
_RWSTD_SPECIALIZE_FACET_ID (messages, <wchar_t>);
_RWSTD_DEFINE_FACET_FACTORY (static, messages, <wchar_t>, wmessages);
_RWSTD_SPECIALIZE_USE_FACET (wmessages);
