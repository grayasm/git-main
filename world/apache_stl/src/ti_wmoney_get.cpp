 ...
 *
 * $Id: ti_wmoney_get.cpp 550076 2007-06-23 18:18:24Z sebor $
 *
 ***************************************************************************
 *
...
_RWSTD_SPECIALIZE_FACET_ID (money_get, TARGS_W);
_RWSTD_DEFINE_FACET_FACTORY (static, money_get, TARGS_W, wmoney_get);
_RWSTD_SPECIALIZE_USE_FACET (wmoney_get);
