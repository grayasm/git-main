    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            if (statusListener.waitEvents() && statusListener.isConnected()) {
                ...
                O2GRequest request = createEntryOrderRequest(session, offer.getOfferID(), sampleParams.getAccountID(), iAmount, sampleParams.getRate(), sampleParams.getBuySell(), sOrderType);
                if (request == null) {
