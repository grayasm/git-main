...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\TableManagerSamples\CreateEntry>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\TableManagerSamples\CreateEntry>ant run
