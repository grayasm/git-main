...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (statusListener.waitEvents() && statusListener.isConnected()) {
                ...
                Map<String, CloseOrdersData> closeOrdersData = getCloseOrdersData(session, sampleParams.getAccountID(), responseListener);
                ...
                if (account == null) {
                    if (sampleParams.getAccountID().isEmpty()) {
                        ...
                        System.out.println(String.format("The account '%s' is not valid",
    ...
    private static Map<String, CloseOrdersData> getCloseOrdersData(O2GSession session, String sAccountID, ResponseListener responseListener) throws Exception {
