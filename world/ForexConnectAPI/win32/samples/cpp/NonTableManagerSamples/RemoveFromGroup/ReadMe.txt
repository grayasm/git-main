RemoveFromGroup application

Brief
===============================================================================
This sample shows how to remove an order from a contigency group.
The sample performs the following actions:
1. Login.
2. Remove the specified order from existing contingency group.
3. Logout.
