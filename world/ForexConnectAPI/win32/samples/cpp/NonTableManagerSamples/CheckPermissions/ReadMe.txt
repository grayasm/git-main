...
Brief
===============================================================================
This sample shows how to check account permissions for an instrument
The sample performs the following actions:
1. Login.
2. Request all permissions for the specified instrument.
3. Print all received permissions.
4. Logout.
