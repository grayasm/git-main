GetLastOrderUpdate application

Brief
===============================================================================
This sample shows how to get up-to-date information about an order.
The sample performs the following actions:
1. Login.
2. Open a position.
3. Get the last state of the order that opened the position from the step 2.
4. Logout.
