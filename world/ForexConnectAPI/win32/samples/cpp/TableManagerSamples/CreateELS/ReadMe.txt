CreateELS application

Brief
===============================================================================
This sample shows how to create an order with attached stop and limit orders.
The sample performs the following actions:
1. Login.
2. Create an entry order with attached stop and limit orders.
3. Logout.
...
/ordertype | --ordertype 
Type of an entry order. Possible values are: LE - entry limit, SE - entry stop. Default value is LE. Optional parameter.
