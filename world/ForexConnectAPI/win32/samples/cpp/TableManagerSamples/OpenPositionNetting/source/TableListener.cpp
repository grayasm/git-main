...
void TableListener::setTradesTable(IO2GTradesTable *tradesTable)
{
    ...
    case Orders:
    {
                ...
                (isClosingOrder(order) || isOpeningOrder(order)))
        {
            ...
            if (trade)
                ...
                mOrderMonitorNetting = new OrderMonitorNetting(order);
        }
    }
    break;
    case Trades:
...
void TableListener::printUpdatedTrades(std::vector<IO2GTradeRow*> &updatedTrades, std::string &sOrderID)
{
