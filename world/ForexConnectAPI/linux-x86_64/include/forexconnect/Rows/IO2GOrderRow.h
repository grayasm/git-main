...
class Order2Go2 IO2GOrderRow : public IO2GRow
{
 protected:
    IO2GOrderRow();
 ...
 public:
    ...
    virtual O2GContingencyType getContingencyType() = 0;
...
class IO2GOrderTableRow : public IO2GOrderRow
{
 ...
 public:
    ...
    virtual O2GRateType getTypeStop() = 0;
    virtual O2GRateType getTypeLimit() = 0;
