...
class Order2Go2 IO2GOfferRow : public IO2GRow
{
 protected:
    IO2GOfferRow();
 ...
 public:
    ...
    virtual O2GInstrumentType getInstrumentType() = 0;
    ...
    virtual double getDividendSell() = 0;
    virtual double getDividendBuy() = 0;
    //
    ...
    virtual bool isDividendSellValid() = 0;
    virtual bool isDividendBuyValid() = 0;
};
