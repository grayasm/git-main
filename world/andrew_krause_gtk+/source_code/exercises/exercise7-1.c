...
static void new_clicked (GtkButton*, TextEditor*);
static void open_clicked (GtkButton*, TextEditor*);
static void save_clicked (GtkButton*, TextEditor*);
static void cut_clicked (GtkButton*, TextEditor*);
static void copy_clicked (GtkButton*, TextEditor*);
static void paste_clicked (GtkButton*, TextEditor*);
          ...
          char *argv[])
{
  ...
  gtk_box_pack_start (GTK_BOX (vbox), cut, FALSE, FALSE, 0);
  gtk_box_pack_start (GTK_BOX (vbox), copy, FALSE, FALSE, 0);
  gtk_box_pack_start (GTK_BOX (vbox), paste, FALSE, FALSE, 0);
