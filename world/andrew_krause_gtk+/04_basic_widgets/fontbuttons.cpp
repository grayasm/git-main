...
void font_changed (GtkFontButton*, GtkWidget*);
int main(int argc, char** argv)
{
	...
	PangoFontDescription* initial_font = pango_font_description_from_string(
		"Sans Bold 12");
...
/* When the font is changed, display the font both as the text of a label and
   as teh label's physical font.
*/
void font_changed (GtkFontButton* button, GtkWidget* label)
{
	gchar buffer[512];
