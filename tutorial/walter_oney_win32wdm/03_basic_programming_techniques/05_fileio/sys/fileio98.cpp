...
/*
	Compile this file using __cdecl as the default calling convention and
	without precompiled headers. Note that the project settings include the win_me
	include and library directories and vxdwraps.clb as one of the libraries.
*/
...
// Note that the WinME DDK has a wrapper for Exec_VxD_Int that doesn't
// suit our needs
