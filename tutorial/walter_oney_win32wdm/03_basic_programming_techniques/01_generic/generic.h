...
GENERICAPI VOID		GENERIC_EXPORT InitializeQeue(PDEVQUEUE pdq, PDRIVER_STARTIO StartIo);
...
GENERICAPI VOID		GENERIC_EXPORT AllowRequeusts(PDEVQUEUE pdq);
...
GENERICAPI VOID		GENERIC_EXPORT WaitForCurrentIrp(PDEVQUEUE* q, ULONG nq);
