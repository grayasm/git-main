/*    Cap 3.2.20 Complete Code for basicwin
 */
...
/*    These are used arguments to nearly every Xlib routine, so it
...
int main(int argc, char **argv)
{
	...
	int window_size = 0;           /* BIG_ENOUGH or TOO_SMALL to display
	                                  contents. */
	...
	else
	{
		 ...
		 *    here to find an acceptable size and then create
		 *    a pixmap of that size; this requires that the application
	 ...
	 *    were set by the user, the flags would be USPosition and
	 ...
	 *    settings of the window when mapped; note that PPosition and PSize
			   ...
			   unsigned int win_width, unsigned int win_height)
{
	 ...
	 *    we need to locate for XDrawString and the baseline is one
