...
/*
  ...
  have (1) an empty declaration of function (line 39) and a partial template
  specialization (line 43) with only 2 template types R and ...A
  ...
  by invoke_derived and hidden by having only a pointer to invoke_base (line 56)
  in the struct body.

  This moves the call to user function pointer be moved into invoke_derived
  (line 32).

  In line 34 F& must be an address because lambda (generated by the compiler)
