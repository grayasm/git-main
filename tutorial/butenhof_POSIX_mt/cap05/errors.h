 ...
 * When compiled with -DDEBUG, it results in calling printf with the
 * specified argument list. When DEBUG is not defined, it expands to nothing.
 */
 ...
 * where function calls, even in contexts where a trailing ";" would
 ...
 * errno_abort can be used as if they where function calls.
 */
