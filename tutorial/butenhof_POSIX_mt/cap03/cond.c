...
int main(int argc, char** argv)
{
	...
	if(status) err_abort(status, "Create wait thread");

	/* Wait on the condition variable for 2 seconds, or until
	 * signaled by the wait_thread. Normally, wait_thread should
	 * signal. If you raise "hibernation" above 2 seconds, it will
	 * time out.
	 */
