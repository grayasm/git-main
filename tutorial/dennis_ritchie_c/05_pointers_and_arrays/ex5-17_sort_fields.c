/* Cap.5 Pointers and Arrays, pag.121

   Exercise 5-17: Add a field-handling capability, so sorting may be done on
                  fields within lines, each field sorted according to an
                  independent set of options. (The index for this book was
                  sorted with -df for the index category and -n for the page
                  numbers.)
*/
...
int pos1 = 0;   /* field beginning with pos 1 */
...
void substr_(char *s, char *str, int maxstr)
{
    int i, j, len;
