/* Cap.1 A Tutorial Introduction, pag.24

   Exercise 1-13: Write a program to print a histogram of the lengths of words
                  in it's input. It is easy to draw a histogram with the bars
                  horizontal; a vertical orientation is more challenging.

   obs: I created both a horizontal and a vertical histogram.
*/
