/* Cap.7 Input and Output, pag.165
   ...
   Exercise 7-7: Modify the pattern finding program of Chapter 5 to take its
                 ...
                 arguments, from the standard input. Should the file name
                 be printed when a matching line is found?

   http://www.learntosolveit.com/cprogramming/Ex_7.7.html
*/
