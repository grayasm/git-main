/* Cap.8 The Unix System Interface, pag.189
   ...
   Exercise 8-7: malloc accepts a size request without checking its plausibility
                 free believes that the block it is asked to free contains a
                 valid size field. Improve these routines so they take more
                 pains with error checking.

   http://www.learntosolveit.com/cprogramming/Ex_8.7_malloc.html

   WIN32: unresolved external symbol sbrk referenced in function morecore
*/
