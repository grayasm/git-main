/* benchmarking sequencial matrix multiplication.
   ...
   As it stands right now, this sequential version is WAY FASTER.
   Most probably because of the overhead of "fork-join" in the omp version.
*/
