...
void add_stock_icon (GtkIconFactory*, const gchar*, const gchar*);
...
int main (int argc, char** argv)
{
	...
	while (list[i].location != NULL)
	{
		...
		GtkToolItem* item = gtk_tool_button_new_from_stock (list[i].stock_id);
...
void add_stock_icon (GtkIconFactory* factory,
                     const gchar* location,
                     const gchar* stock_id)
{
