 ...
 *
 * Demonstrates how to use APC's (synchronous procedure calls)
 * instead of signaled objects to service multiple outstanding 
 * overlapped operations on a file.
 */
...
/* I/O Completion routine gets called when app is alertable
 * (in WaitForSingleObjectEx) and an overlapped I/O operation
 * has completed.
 */
