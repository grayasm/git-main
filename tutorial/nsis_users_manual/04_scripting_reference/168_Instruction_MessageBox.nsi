...
;
; Displays a MessageBox containing the text "messagebox_text". 
; mb_option_list must be one or more of the following, delimited by |
;
...
; Use the /SD parameter with one of the return_check values above to specify 
; the option that will be used when the installer is silent.
