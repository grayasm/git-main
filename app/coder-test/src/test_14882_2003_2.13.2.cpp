...
void test_14882_2003_2_13_2::run(const char* test)
{
	test_14882_2003_2_13_2 obj;
	obj.test_gen::run(test);
};


char* test_14882_2003_2_13_2::GetText()
{	
	char* text=
...
void test_14882_2003_2_13_2::SetGrammar(ebnf::DefaultGrammar::Ptr& grammar)
{
...
void test_14882_2003_2_13_2::SetSyntax(lex::Base::Syntax& ref)
{	
...
void test_14882_2003_2_13_2::SetReports(lex::Base::Reports& /*rep*/)
{
...
void test_14882_2003_2_13_2::AddAsProduction(lex::Base::Syntax& ref, const char* p[], const int a[], int lim)
{	
