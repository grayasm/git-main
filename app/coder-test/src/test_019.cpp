...
void test19::run(const char* test)
{
	test19 obj;
...
void test19::SetGrammar(ebnf::DefaultGrammar::Ptr& grammar)
{
...
void test19::SetSyntax(lex::Base::Syntax& ref)
{	
	const char* p1[]={".2",";"};
	const char* p2[]={"1.",";"};
	const char* p3[]={"1.2",";"};
...
void test19::SetReports(lex::Base::Reports& reps)
{

	lex::Report rep[17];
	rep[0].report(lex::Error("expected digits", 1), 916, 106, 2);
	rep[1].report(lex::Error("expected digits", 1), 916, 106, 2);
	rep[2].report(lex::Error("expected digits", 1), 926, 107, 2);
	rep[3].report(lex::Error("expected digits", 1), 933, 108, 2);
	rep[4].report(lex::Error("expected digits", 1), 939, 109, 3);
	rep[5].report(lex::Error("expected digits", 1), 946, 110, 3);
	rep[6].report(lex::Error("expected digits", 1), 953, 111, 3);
	rep[7].report(lex::Error("expected digits", 1), 960, 112, 3);
	rep[8].report(lex::Error("expected digits", 1), 967, 113, 3);
	rep[9].report(lex::Error("expected ;", 1), 976, 114, 6);
	rep[10].report(lex::Error("expected ;", 1), 982, 115, 4);
	rep[11].report(lex::Error("expected ;", 1), 992, 116, 8);
	rep[12].report(lex::Error("expected ;", 1), 998, 117, 4);
	rep[13].report(lex::Error("expected ;", 1), 1004, 118, 4);
	rep[14].report(lex::Error("expected ;", 1), 1010, 119, 4);
	rep[15].report(lex::Error("expected ;", 1), 1019, 120, 7);
	rep[16].report(lex::Error("expected ;", 1), 1025, 121, 4);	
...
void test19::AddAsProduction(lex::Base::Syntax& ref, const char* p[], const int a[], int lim)
{	
