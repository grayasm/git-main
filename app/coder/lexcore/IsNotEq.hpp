...
#ifndef __IsNotEq_hpp__
#define __IsNotEq_hpp__
...
namespace lex
{
	...
	class IsNotEq : public Base
	{
	public:
		typedef misc::autoptr<IsNotEq> Ptr;
		

		~IsNotEq();
		IsNotEq(const Base::Ptr& left, const Base::Ptr& right);
		IsNotEq(const IsNotEq& tc);
		IsNotEq& operator=(const IsNotEq& tc);
