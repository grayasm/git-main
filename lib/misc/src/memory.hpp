...
namespace misc
{
	...
	class raw_storage_iterator :
		public iterator<misc::output_iterator_tag,void,void,void,void>
	{
	protected:
		OutputIterator iter;
	...
	*/
	...
	template <typename T>
	misc::pair <T*,ptrdiff_t> get_temporary_buffer ( ptrdiff_t n )
	{
		...
		return (misc::pair<T*, ptrdiff_t>(ptrbuff, n));
	}
	//////////////////////////////////////////////////////////////////////////
	/*
	...
	*/
	...
	ForwardIterator uninitialized_copy ( InputIterator first, InputIterator last, ForwardIterator result )
	{
		...
		{
			new (static_cast<void*>(&*result)) typename misc::iterator_traits<ForwardIterator>::value_type(*first);
		}//for
		return result;
	}
	...
	*/
	...
	void uninitialized_fill ( ForwardIterator first, ForwardIterator last, const T& x )
	{
		...
		{
			new (static_cast<void*>(&*first)) typename misc::iterator_traits<ForwardIterator>::value_type(x);
		}//for
	}
	...
	*/
	...
	public:
		...
		*/
		template<typename U>
		bool operator==(const misc::allocator<U>&) const throw()
		{
