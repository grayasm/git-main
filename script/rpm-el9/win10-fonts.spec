...
cp -v     $RPM_SOURCE_DIR/win10-fonts.mk  $RPM_BUILD_DIR/win10-fonts/Makefile
...
%changelog
* Sun Oct 09 2022 Mihai Vasilian <grayasm@gmail.com> 1.2-1.el9
- Create the package for el9.
* Sun Oct 20 2019 Mihai Vasilian <grayasm@gmail.com> 1.1-1.el8
